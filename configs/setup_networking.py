...
# Created libvirt networks of minrouting with DHCP to get FW rules to
# isolate DHCP on the given network.

_iptables_conf_template = '''# Auto-generated by {user} on {timestamp}
...
class TMgrub(object):
    ...
    def configure_dnsmasq(self, prepath):
        ...
        ifaceaddr = None        # Might become a dict
        try:
